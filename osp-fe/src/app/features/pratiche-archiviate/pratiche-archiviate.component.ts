...
@Component({
  selector: 'app-pratiche-archiviate',
  templateUrl: './pratiche-archiviate.component.html',
  styleUrls: ['./pratiche-archiviate.component.css']
})
export class PraticheArchiviateComponent extends BasePraticaAction implements OnInit {
  ...
  titleTable = 'Pratiche archiviate';
  exportName = 'Pratiche archiviate';
  ...
  cercaPratiche(){
    ...
    pratica.idsStatiPratica = [environment.statiPratica.archiviata, environment.statiPratica.revocata,
    environment.statiPratica.decaduta, environment.statiPratica.annullata, environment.statiPratica.rinunciata,
