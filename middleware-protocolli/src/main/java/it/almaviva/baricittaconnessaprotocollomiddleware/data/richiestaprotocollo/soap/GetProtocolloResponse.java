...
@XmlType(name = "getProtocolloResponse", namespace = "http://server.ws.protocollo.linksmt.it/", propOrder = {
    "_return"
})
@ToString
public class GetProtocolloResponse {
    ...
    protected GetProtocolloResponse.Return _return;
     ...
     * @return
     *     possible object is
     *     {@link GetProtocolloResponse.Return }
     *     
     */
    public GetProtocolloResponse.Return getReturn() {
        return _return;
    }
     ...
     *     
     */
    public void setReturn(GetProtocolloResponse.Return value) {
        this._return = value;
    }
